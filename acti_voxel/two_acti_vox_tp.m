...
for j=1:6
    ...
    pri_vis_cortex_tp(1,j)        = pri_vis_cortex_count;
    vis_cortex_tp(1,j)            = vis_cortex_count;
    out_vis_cortex_tp(1,j)        = out_vis_cortex_count;
    pri_audio_cortex_tp(1,j)      = pri_audio_cortex_count;
    out_pri_audio_cortex_tp(1,j)  = out_pri_audio_cortex_count;
    pri_motor_cortex_tp(1,j)      = pri_motor_cortex_count;
    out_pri_motor_cortex_tp(1,j)  = out_pri_motor_cortex_count;

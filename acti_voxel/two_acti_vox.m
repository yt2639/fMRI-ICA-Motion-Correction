...
pri_vis_cortex_35=zeros(1,6);
vis_cortex_35=zeros(1,6);
out_vis_cortex_35=zeros(1,6);

pri_audio_cortex_35=zeros(1,6);
out_pri_audio_cortex_35=zeros(1,6);

pri_motor_cortex_35=zeros(1,6);
out_pri_motor_cortex_35=zeros(1,6);
...
for j=1:6
    ...
    pri_vis_cortex_35(1,j)        = pri_vis_cortex_count;
    vis_cortex_35(1,j)            = vis_cortex_count;
    out_vis_cortex_35(1,j)        = out_vis_cortex_count;
    pri_audio_cortex_35(1,j)      = pri_audio_cortex_count;
    out_pri_audio_cortex_35(1,j)  = out_pri_audio_cortex_count;
    pri_motor_cortex_35(1,j)      = pri_motor_cortex_count;
    out_pri_motor_cortex_35(1,j)  = out_pri_motor_cortex_count;
    
end
   
%%
figure;
plot(1:6,pri_vis_cortex_35,'LineWidth',1.5);
hold on
plot(1:6,pri_vis_cortex_34,'LineWidth',1.5);
hold on
plot(1:6,pri_vis_cortex_tp,'LineWidth',1.5);
xticks(1:6);
...
%%
figure;
plot(1:6,vis_cortex_35,'LineWidth',1.5);
hold on
plot(1:6,vis_cortex_34,'LineWidth',1.5);
hold on
plot(1:6,vis_cortex_tp,'LineWidth',1.5);
xticks(1:6);
xticklabels([0.05,0.02,0.01,0.005,0.002,0.001]);
xlabel('p-value')
ylabel('# of activated voxels')
...
%%
figure;
plot(1:6,out_vis_cortex_35,'LineWidth',1.5);
hold on
plot(1:6,out_vis_cortex_34,'LineWidth',1.5);
hold on
plot(1:6,out_vis_cortex_tp,'LineWidth',1.5);
xticks(1:6);
xticklabels([0.05,0.02,0.01,0.005,0.002,0.001]);
xlabel('p-value')
ylabel('# of activated voxels')
...
%%
figure;
plot(1:6,pri_audio_cortex_35,'LineWidth',1.5);
hold on
plot(1:6,pri_audio_cortex_34,'LineWidth',1.5);
hold on
plot(1:6,pri_audio_cortex_tp,'LineWidth',1.5);
xticks(1:6);
xticklabels([0.05,0.02,0.01,0.005,0.002,0.001]);
xlabel('p-value')
ylabel('# of activated voxels')
...
%%
figure;
plot(1:6,out_pri_audio_cortex_35,'LineWidth',1.5);
hold on
plot(1:6,out_pri_audio_cortex_34,'LineWidth',1.5);
hold on
plot(1:6,out_pri_audio_cortex_tp,'LineWidth',1.5);
xticks(1:6);
xticklabels([0.05,0.02,0.01,0.005,0.002,0.001]);
xlabel('p-value')
ylabel('# of activated voxels')
...
%%
figure;
plot(1:6,pri_motor_cortex_35,'LineWidth',1.5);
hold on
plot(1:6,pri_motor_cortex_34,'LineWidth',1.5);
hold on
plot(1:6,pri_motor_cortex_tp,'LineWidth',1.5);
xticks(1:6);
xticklabels([0.05,0.02,0.01,0.005,0.002,0.001]);
xlabel('p-value')
ylabel('# of activated voxels')
...
%%
figure;
plot(1:6,out_pri_motor_cortex_35,'LineWidth',1.5);
hold on
plot(1:6,out_pri_motor_cortex_34,'LineWidth',1.5);
hold on
plot(1:6,out_pri_motor_cortex_tp,'LineWidth',1.5);
xticks(1:6);
xticklabels([0.05,0.02,0.01,0.005,0.002,0.001]);
xlabel('p-value')
ylabel('# of activated voxels')

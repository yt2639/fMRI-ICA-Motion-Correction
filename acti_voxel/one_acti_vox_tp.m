...
% t=1.97; % p<0.05
    for j=1:6
        ...
        pri_vis_cortex_tp(i,j)        = pri_vis_cortex_count;
        vis_cortex_tp(i,j)            = vis_cortex_count;
        out_vis_cortex_tp(i,j)        = out_vis_cortex_count;
        pri_audio_cortex_tp(i,j)      = pri_audio_cortex_count;
        out_pri_audio_cortex_tp(i,j)  = out_pri_audio_cortex_count;
        pri_motor_cortex_tp(i,j)      = pri_motor_cortex_count;
        out_pri_motor_cortex_tp(i,j)  = out_pri_motor_cortex_count;

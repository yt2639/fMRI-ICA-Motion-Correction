...
%     pri_motor_cortex_beta=sum(pri_motor_cortex_beta(:))/length(find(pri_motor_cortex_mask~=0));
    ...
    pri_vis_cortex_34(1,j)        = pri_vis_cortex_beta;
    vis_cortex_34(1,j)            = vis_cortex_beta;
    out_vis_cortex_34(1,j)        = out_vis_cortex_beta;
    pri_audio_cortex_34(1,j)      = pri_audio_cortex_beta;
    out_pri_audio_cortex_34(1,j)  = out_pri_audio_cortex_beta;
    pri_motor_cortex_34(1,j)      = pri_motor_cortex_beta;
    out_pri_motor_cortex_34(1,j)  = out_pri_motor_cortex_beta;

...
%     pri_motor_cortex_beta=sum(pri_motor_cortex_beta(:))/length(find(pri_motor_cortex_mask~=0));
    ...
    pri_vis_cortex_35(1,j)        = pri_vis_cortex_beta;
    vis_cortex_35(1,j)            = vis_cortex_beta;
    out_vis_cortex_35(1,j)        = out_vis_cortex_beta;
    pri_audio_cortex_35(1,j)      = pri_audio_cortex_beta;
    out_pri_audio_cortex_35(1,j)  = out_pri_audio_cortex_beta;
    pri_motor_cortex_35(1,j)      = pri_motor_cortex_beta;
    out_pri_motor_cortex_35(1,j)  = out_pri_motor_cortex_beta;
...
hold on
plot(1:6,1.1.*pri_motor_cortex_tp,'LineWidth',1.5);
xticks(1:6);
xticklabels([0.05,0.02,0.01,0.005,0.002,0.001]);
xlabel('p-value')
ylabel('Beta Value')
